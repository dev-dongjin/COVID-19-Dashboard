...
import file_handling as fs_handle
import time

def capture():
    rank_20 = fs_handle.rank_20
    options = Options()
    ...
    driver.set_window_size(page_width, int(page_height)/6)
    time.sleep(5)
    ...
    south_korea = driver.find_element_by_css_selector(f'a[href="{rank_20}"]')
    ...
    im1 = Image.open('./data/screenshot.png')
    left = up['x']
    top = up['y']
    ...
    im1.save('./data/my_screenshot_name1.png')
    print("사진1 저장")

    print(up2)
    print(up_size2)
    im2 = Image.open('./data/screenshot.png')
    left = up2['x']
    top = up2['y']
    ...
    im2.save('./data/my_screenshot_name2.png')
    print("사진2 저장")
    ...
    print(down3)
    print(down_size3)
    im3 = Image.open('./data/screenshot.png')
    left = up3['x']
    top = up3['y']
    ...
    im3.save('./data/my_screenshot_name3.png')
    print("사진3 저장")
